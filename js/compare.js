...
d3.select("#architecture-container")
    .append("div")
        ...
        .html('<i class="fa-solid fa-arrow-left" id="exit-button-arrow"></i><span id="exit-button-text">返回</span>')
...
d3.select("#global-umap-svg-container")
    .append("div")
        .attr("id", "global-umap-title-container")
        .append("div")
            .attr("id", "global-umap-title-1")
            .text("Evolution Trajectory")
d3.select("#global-umap-title-container")
        .append("div")
            .attr("id", "global-umap-title-2")
            .text("Image representations projected onto 2D space")
d3.select("#architecture-container")
    .append("div")
